...
public class TCP_Unicast_Auto_Send extends AsyncTask<String, Void, String> {
	...
	protected String doInBackground(String... arg0) {
		...
		try{
			...
			output.close();
			socket.close();
			Log.d(log_Head + " - doInBackground", "Closed Socket");
			Thread.sleep(30000);
			Log.d(log_Head + " - doInBackground", "Thread waked");
			return "Success : " + data;
		}catch (Exception e){
